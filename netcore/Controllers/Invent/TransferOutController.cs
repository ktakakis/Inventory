...
namespace netcore.Controllers.Invent
{
    ...
    public class TransferOutController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TransferOut.OrderByDescending(x => x.createdAt).Include(t => t.transferOrder).Include(x => x.branchFrom).Include(x => x.branchTo);
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                ViewData["StatusMessage"] = "Σφάλμα. Παρακαλώ πρώτα διαγράψτε τα προϊόντα που έχετε Παραλάβει.";
                return View(transferOut);
            }
            ...
            try
            {
                ...
                await _context.SaveChangesAsync();
                TempData["TransMessage"] = "Η Διαγραφή της Μεταφοράς " + transferOut.transferOutNumber + " έγινε με Επιτυχία";
                return RedirectToAction(nameof(Index));
            }
            catch (Exception ex)
            {
