...
namespace netcore.Controllers.Invent
{
    ...
    public class PurchaseOrderLineController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("purchaseOrderLineId,createdAt,discountAmount,price,productId,purchaseOrderId,qty,totalAmount")] PurchaseOrderLine purchaseOrderLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("purchaseOrderLineId,createdAt,discountAmount,price,productId,purchaseOrderId,qty,totalAmount")] PurchaseOrderLine purchaseOrderLine)
        {
